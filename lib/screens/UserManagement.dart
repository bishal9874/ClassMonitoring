...
//     // Get the screen width to make the UI responsive
//     final screenWidth = MediaQuery.of(context).size.width;
//     final screenHeight = MediaQuery.of(context).size.height;
//     // Conditionally select the gradient based on the screen width
//     final bodyGradient = screenWidth > 600
//         ? const LinearGradient(
//             // Gradient for wider screens (e.g., tablets)
//             colors: [Color(0xFFE8F5E9), Color(0xFFC8E6C9)], // Greenish theme
//             begin: Alignment.topCenter,
//             end: Alignment.bottomCenter,
//           )
//         : const LinearGradient(
//             // Original gradient for smaller screens (e.g., phones)
...
//       ),
//       body: Container(
//         // Apply the determined responsive gradient
